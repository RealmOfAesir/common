...
namespace roa {
    ...
    public:
        register_response_message(message_sender sender, int8_t admin_status, int error_number, std::string error_str) noexcept;

        ~register_response_message() override;
        ...
        static constexpr uint32_t id = REGISTER_RESPONSE_MESSAGE_TYPE;
    };
